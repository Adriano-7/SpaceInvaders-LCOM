...
static const xpm_row_t *game_xpm_name[] = {nave_xpm, osvaldo_xpm, osvaldo_xpm1, ivan_xpm,ivan_xpm1, miro_xpm, miro_xpm1, bullet_xpm};
static const xpm_row_t *symbol_xpm_name[] = {heart_xpm, two_points_xpm};
static const xpm_row_t *menu_xpm_name[] = {logotipo_xpm,playgame_xpm, highScore_xpm, quitGame_xpm};
...
xpm_image_t game_xpm[8];
xpm_image_t menu_xpm[4];
xpm_image_t symbol_xpm[2];
xpm_image_t letters_xpm[26];
xpm_image_t numbers_xpm[10];

uint8_t* game_xpm_map[8];
uint8_t* menu_xpm_map[4];
